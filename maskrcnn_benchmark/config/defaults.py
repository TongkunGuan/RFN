...
_C.MODEL.RRPN = CN()
_C.MODEL.RRPN.ANCHOR_SIZES = (8, 16, 32)
_C.MODEL.RRPN.ASPECT_RATIOS = (0.2, 0.5, 1.0)
...
_C.MODEL.ROI_REC_HEAD = CN()
_C.MODEL.ROI_REC_HEAD.POOLER_RESOLUTION = (8, 35)
_C.MODEL.ROI_REC_HEAD.MAX_POSITIVE_NUM = 128
_C.MODEL.ROI_REC_HEAD.POOLER_SCALES = (1.0 / 16,)
# POOLER_TYPE can be chosen from ["RoIRotated", "RoIRotatedKeep"]
_C.MODEL.ROI_REC_HEAD.POOLER_TYPE = "RoIRotated"
_C.MODEL.ROI_REC_HEAD.SAMPLING_RATIO = 2
_C.MODEL.ROI_REC_HEAD.FEATURE_EXTRACTOR = "ResNet50Conv5RecFeatureExtractor"
_C.MODEL.ROI_REC_HEAD.NUM_CLASSES = 99
# alphabet file
_C.MODEL.ROI_REC_HEAD.ALPHABET = ""
_C.MODEL.ROI_REC_HEAD.PREDICTOR = "RRPNE2EC4Predictor"
_C.MODEL.ROI_REC_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = False
_C.MODEL.ROI_REC_HEAD.BOXES_MARGIN = 1.2
_C.MODEL.ROI_REC_HEAD.REC_DETACH = False
# Choose from ["BOTH", "POS"]
_C.MODEL.ROI_REC_HEAD.POS_ONLY = True
_C.MODEL.ROI_REC_HEAD.ACTIVATION = "ReLU"
_C.MODEL.ROI_REC_HEAD.FG_IOU_THRESHOLD = 0.6
_C.MODEL.ROI_REC_HEAD.BG_IOU_THRESHOLD = 0.6

_C.MODEL.ROI_REC_HEAD.TRANSFORMER = CN()
_C.MODEL.ROI_REC_HEAD.TRANSFORMER.HEAD_NUM = 16
_C.MODEL.ROI_REC_HEAD.TRANSFORMER.DROPOUT = 0.1
_C.MODEL.ROI_REC_HEAD.TRANSFORMER.FEATURE_2DATT = False
...
RECHEAD_TYPE = {
    ...
    "REF_TRANSFORMER": RECG_REFINED_WITHSHORTCURT
}
"""
_C.MODEL.ROI_REC_HEAD.STRUCT = "REFINED"

_C.MODEL.REC_ON = False
_C.MODEL.FP4P_ON = False
...
# Cascade roi_heads
_C.MODEL.ROI_HEADS.RECUR_ITER = 1
...
_C.MODEL.ROI_HEADS.RBBOX_REG_WEIGHTS = (10., 10., 5., 5., 1.)
...
# Mish for activation function
_C.MODEL.RESNETS.USE_MISH = False
...
_C.TEST.DATASET_NAME = ''
_C.TEST.MERGE_BOX = False
_C.TEST.CASCADE = False
# The MODE can be chosen in (DET, E2E)
_C.TEST.MODE = "DET"
